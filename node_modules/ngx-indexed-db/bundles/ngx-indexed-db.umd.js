(function (global, factory) {
    ...
    (global = global || self, factory(global['ngx-indexed-db'] = {}, global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators));
    ...
    var NgxIndexedDBService = /** @class */ (function () {
        ...
        NgxIndexedDBService.prototype.add = function (storeName, value, key) {
            ...
            return rxjs.from(new Promise(function (resolve, reject) {
                openDatabase(_this.indexedDB, _this.dbConfig.name, _this.dbConfig.version)
                    .then(function (db) {
        ...
        NgxIndexedDBService.prototype.openCursorByIndex = function (storeName, indexName, keyRange, mode) {
            ...
            return rxjs.from(new Promise(function (resolve, reject) {
                openDatabase(_this.indexedDB, _this.dbConfig.name, _this.dbConfig.version)
                    .then(function (db) {
                    validateBeforeTransaction(db, storeName, reject);
                    var transaction = createTransaction(db, optionsGenerator(mode, storeName, reject, resolve));
                    var objectStore = transaction.objectStore(storeName);
                    var index = objectStore.index(indexName);
